...
function renderNode(node) {
  ...
  if (!node.children || node.children.length === 0) {
    ...
    return import_react2.default.createElement(Component, { key: node.id, ...resolvedProps });
  }
  return import_react2.default.createElement(
    Component,
...
function renderToReactEmail(document) {
  ...
  return import_react2.default.createElement(
    ...
    { lang: "en", dir: "ltr" },
    import_react2.default.createElement(import_components.Head, null),
    document.meta.previewText ? import_react2.default.createElement(import_components.Preview, null, document.meta.previewText) : null,
...
function EditorToolbar({
  ...
  const [exporting, setExporting] = (0, import_react4.useState)(false);
  const modeLabels = {
    visual: { label: "Visual", Icon: Icons.eye },
    code: { label: "Code", Icon: Icons.code },
    preview: { label: "Preview", Icon: Icons.monitor }
  };
  const handleExportHTML = (0, import_react4.useCallback)(async () => {
    setExporting(true);
    try {
  ...
  return import_react4.default.createElement(
      ...
      import_react4.default.createElement(
        ...
        ...modes.map((m) => {
          ...
          return import_react4.default.createElement(
            ...
            import_react4.default.createElement(Icon, { size: 14 }),
            ` ${label}`
          );
        })
      )
    ...
    import_react4.default.createElement(
      ...
      actions,
      // JSON Export
      showExportJSON && (ExportJSONButton ? import_react4.default.createElement(ExportJSONButton, { onClick: handleExportJSON }) : import_react4.default.createElement(
        "button",
        {
          className: "oe-btn",
        ...
        import_react4.default.createElement(Icons.copy, { size: 14 }),
        "JSON"
      )),
      // HTML Export
      showExportHTML && (ExportHTMLButton ? import_react4.default.createElement(ExportHTMLButton, {
        ...
        import_react4.default.createElement(Icons.download, { size: 14 }),
...
function ComponentCard({ definition, onClick, className }) {
  ...
  return import_react5.default.createElement(
    ...
    import_react5.default.createElement(
      ...
      import_react5.default.createElement(Icon, { size: 18 })
    ),
    import_react5.default.createElement(
      "span",
...
function LayerNode({ node, depth = 0 }) {
  ...
  return import_react6.default.createElement(
    ...
    import_react6.default.createElement(
      ...
      hasChildren ? import_react6.default.createElement(
        "span",
        {
        ...
        expanded ? import_react6.default.createElement(Icons.chevronDown, { size: 12 }) : import_react6.default.createElement(Icons.chevronRight, { size: 12 })
      ) : import_react6.default.createElement("span", {
        className: "oe-layer-item-icon",
        style: { width: 12 }
      }),
      import_react6.default.createElement(Icon, { size: 12 }),
      import_react6.default.createElement("span", { className: "oe-layer-item-label" }, label)
    ),
    hasChildren && expanded ? import_react6.default.createElement(
      "ul",
      { className: "oe-layer-children" },
      node.children.map(
        (child) => import_react6.default.createElement(LayerNode, {
          key: child.id,
          node: child,
          depth: depth + 1
        })
...
function LayerTree({ className }) {
  ...
  return import_react6.default.createElement(
    ...
    import_react6.default.createElement(LayerNode, { node: document.body })
  );
}
...
function EditorSidebar({
  ...
  const [activeTab, setActiveTab] = (0, import_react7.useState)(defaultTab);
  const { selectedNodeId, document, addNode: addNode2 } = useEditor();
  const reg = registry ?? defaultRegistry;
  const grouped = getComponentsByCategory(reg);
  const handleAddComponent = (0, import_react7.useCallback)(
    (def) => {
  ...
  return import_react7.default.createElement(
    ...
    import_react7.default.createElement(
      ...
      import_react7.default.createElement(
        ...
        import_react7.default.createElement(Icons.plus, { size: 14 }),
        " Components"
      ),
      import_react7.default.createElement(
        "button",
        ...
        import_react7.default.createElement(Icons.layers, { size: 14 }),
        " Layers"
      )
    ),
    // Tab content
    import_react7.default.createElement(
      ...
      activeTab === "components" ? (
        ...
        Object.entries(grouped).map(
          ([category, defs]) => import_react7.default.createElement(
            "div",
            ...
            import_react7.default.createElement(
              ...
              defs.map(
                (def) => import_react7.default.createElement(ComponentCard, {
                  key: def.type,
                  definition: def,
        ...
        // Layer tree
        import_react7.default.createElement(LayerTree, null)
      )
    )
  );
}
    ...
    switch (node.type) {
      case "container":
        return import_react8.default.createElement(
          ...
          node.children?.map(
            (child) => import_react8.default.createElement(CanvasNode, { key: child.id, node: child })
          ),
          (!node.children || node.children.length === 0) && import_react8.default.createElement(
            "div",
      ...
      case "image":
        return import_react8.default.createElement("img", {
      ...
      case "hr":
        return import_react8.default.createElement("hr", {
          style: {
            border: "none",
...
function VisualCanvas() {
  ...
  const handleCanvasClick = (0, import_react8.useCallback)(() => {
    selectNode(null);
  }, [selectNode]);
  return import_react8.default.createElement(
    "div",
    ...
    import_react8.default.createElement(
      ...
      import_react8.default.createElement(CanvasNode, { node: document.body })
    )
  );
}
function CodeCanvas() {
  const { document, setDocument } = useEditor();
  const [code, setCode] = (0, import_react8.useState)(() => exportToJSON(document));
  ...
  return import_react8.default.createElement(
    ...
    error && import_react8.default.createElement(
      "div",
      {
        style: {
          padding: "8px 12px",
...
function PreviewCanvas() {
  const { document } = useEditor();
  const [html, setHtml] = (0, import_react8.useState)("");
  ...
  return import_react8.default.createElement(
    ...
    import_react8.default.createElement("iframe", {
      ref: iframeRef,
...
function EditorCanvas({ className }) {
  ...
  const content = (0, import_react8.useMemo)(() => {
    switch (mode) {
      case "visual":
        return import_react8.default.createElement(VisualCanvas, null);
      case "code":
        return import_react8.default.createElement(CodeCanvas, null);
      case "preview":
        return import_react8.default.createElement(PreviewCanvas, null);
      default:
        return import_react8.default.createElement(VisualCanvas, null);
    }
  }, [mode]);
  ...
  switch (schema.type) {
    case "textarea":
      return import_react9.default.createElement(
        "div",
        { className: "oe-field" },
        import_react9.default.createElement("label", { className: "oe-field-label" }, schema.label),
        import_react9.default.createElement("textarea", {
    ...
    case "select":
      return import_react9.default.createElement(
        ...
        import_react9.default.createElement(
          ...
          import_react9.default.createElement("option", { value: "" }, "\u2014"),
          ...(schema.options ?? []).map(
            (opt) => import_react9.default.createElement(
              "option",
...
function PropertiesPanel({ className, registry }) {
  ...
  const reg = registry ?? defaultRegistry;
  const definition = (0, import_react9.useMemo)(
    () => selectedNode ? reg.get(selectedNode.type) : void 0,
    [selectedNode, reg]
  );
  const handlePropertyChange = (0, import_react9.useCallback)(
    (key, value) => {
  ...
  if (!selectedNode || !definition) {
    return import_react9.default.createElement(
      ...
      import_react9.default.createElement(
        ...
        import_react9.default.createElement(Icons.settings, { size: 32 }),
        import_react9.default.createElement("p", null, "Select an element to edit its properties")
      )
    );
  }
  const groups = {};
  ...
  return import_react9.default.createElement(
    ...
    import_react9.default.createElement(
      ...
      import_react9.default.createElement(
        ...
        import_react9.default.createElement(Icons.trash, { size: 16 })
      )
    ),
    ...groupOrder.filter((g) => groups[g] && groups[g].length > 0).map(
      (group) => import_react9.default.createElement(
        "div",
        ...
        ...groups[group].map(
          (prop) => import_react9.default.createElement(PropertyField, {
            key: prop.key,
            schema: prop,
...
function EmailEditor({
  ...
  return import_react10.default.createElement(
    ...
    import_react10.default.createElement(
      ...
      // Toolbar
      showToolbar && toolbar !== false && (toolbar ?? import_react10.default.createElement(EditorToolbar, {
      ...
      import_react10.default.createElement(
        ...
        // Sidebar
        showSidebar && sidebar !== false && (sidebar ?? import_react10.default.createElement(EditorSidebar, { registry })),
        // Canvas
        canvas ?? import_react10.default.createElement(EditorCanvas, null),
        // Properties Panel
        showProperties && propertiesPanel !== false && (propertiesPanel ?? import_react10.default.createElement(PropertiesPanel, { registry }))
      )
    )
  );
}
