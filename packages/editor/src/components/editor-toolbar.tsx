// ─── Editor Toolbar ──────────────────────────────────────────────────────────
// Top toolbar with mode switcher and action buttons.
// Each section is separately replaceable.
...
export function EditorToolbar({
    ...
    const modeLabels: Record<EditorMode, { label: string; Icon: React.ComponentType<any> }> = {
